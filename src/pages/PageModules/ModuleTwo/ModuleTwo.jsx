  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <TextVideoHW
          homeworkLink={
            'https://docs.google.com/document/d/1SS817oUIQmiWxWVLMwQV29cEkPZGgm-s/edit?usp=drive_link&ouid=114783473414938878123&rtpof=true&sd=true'
          }
          ...
          videoId="uOpQlctfYcI"
          deadline="Дедлайн по домашнему заданию к урокам 1 и 2:"
          secondSummary={'Конспект к уроку 2'}
        ...
        <VideoText
          ...
          homework={
            'https://docs.google.com/document/d/1yeRVS8QMyU8Eq1adtLOjquE1LNOVmlXc/edit?usp=drive_link&ouid=114783473414938878123&rtpof=true&sd=true'
          }
          ...
          deadline="Дедлайн по домашнему заданию к урокам 1 и 2:"
          link={
            'https://drive.google.com/file/d/1WpqHfWK9xDNNI83utg4Ka2aAavxlBBWy/view?usp=drive_link'
          }
        />
        ...
        <VideoText
          ...
          homework={
            'https://docs.google.com/document/d/1mOz9JMPYRjBbGFznPSi0EI_9hhUfEaP9/edit?usp=drive_link&ouid=114783473414938878123&rtpof=true&sd=true'
          }
          ...
          deadline="Дедлайн по домашнему заданию к урокам 1 и 2:"
          link={
            'https://drive.google.com/file/d/1s-klPdvkuswL0BqY8ZIVBywJvq4kpMTV/view?usp=drive_link'
          }
        />
        ...
        <VideoText
          ...
          homework={
            'https://docs.google.com/document/d/1trE6XG-nWnXWxkRA7jj-kM-o2h-HSfhV/edit?usp=drive_link&ouid=114783473414938878123&rtpof=true&sd=true'
          }
...
Шумный фон- когда на фоне в том числе находятся разные и яркие предметы."
          ...
          deadline="Дедлайн по домашнему заданию к урокам 1 и 2:"
          link={
            'https://drive.google.com/file/d/1Cq4YCIXbG7d9wadGB0VfwarR-At4qTHm/view?usp=drive_link'
          }
          secondConspect={
            'https://drive.google.com/file/d/1kLPJ0JCk6Dl4n1FiIZrfA9AY_-OWUXC6/view?usp=drive_link'
          }
        />
        ...
        <VideoText
          ...
          homework={
            'https://docs.google.com/document/d/1PaAq4NT9tN-sTn99E13vIKVyqwTAw1au/edit?usp=drive_link&ouid=114783473414938878123&rtpof=true&sd=true'
          }
          ...
          deadline="Дедлайн по домашнему заданию к урокам 1 и 2:"
          link={
            'https://drive.google.com/file/d/1GNCDgAjU-_8eF7mUxvPeZu7J_e8N6O1g/view?usp=drive_link'
          }
          secondConspect={
            'https://drive.google.com/file/d/13-ASip-2vhgsVSWylir1nnmTQiaJctc3/view?usp=drive_link'
          }
        />
